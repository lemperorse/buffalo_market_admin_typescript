                ...
                <li class="items-center">
                  ...
                  isActive
                    ...
                    : 'text-gray-800 hover:text-gray-600',
                            ...
                            <i class="fas fa-user mr-2 text-sm" :class="[isActive ? 'opacity-75' : 'text-gray-400']"></i>
                            จัดการข้อมูลผู้ใช้
                        </a>
                    </router-link>
                </li>
                ...
                <li class="items-center">
                  ...
                  isActive
                    ...
                    : 'text-gray-800 hover:text-gray-600',
                            ...
                            <i class="fas fa-user-secret mr-2 text-sm" :class="[isActive ? 'opacity-75' : 'text-gray-400']"></i>
                            จัดการผู้ดูแล
                        </a>
                    </router-link>
                </li>
                ...
                <li class="items-center">
                  ...
                  isActive
                    ...
                    : 'text-gray-800 hover:text-gray-600',
                            ...
                            <i class="fas fa-clipboard-list mr-2 text-sm" :class="[isActive ? 'opacity-75' : 'text-gray-400']"></i>
                            จัดการประกาศ
                        </a>
                    </router-link>
                </li>
                <li class="items-center">
                  ...
                  isActive
                    ...
                    : 'text-gray-800 hover:text-gray-600',
                            ...
                            <i class="fas fa-key mr-2 text-sm" :class="[isActive ? 'opacity-75' : 'text-gray-400']"></i>
                            คำขอเปลี่ยนรหัสผ่าน
                        </a>
                    </router-link>
                </li>
                ...
                <li class="items-center">
                  ...
                  isActive
                    ...
                    : 'text-gray-800 hover:text-gray-600',
                            ...
                            <i class="fas fa-map-marked-alt mr-2 text-sm" :class="[isActive ? 'opacity-75' : 'text-gray-400']"></i>
                ...
                <li class="items-center">
                  ...
                  isActive
                    ...
                    : 'text-gray-800 hover:text-gray-600',
                            ...
                            <i class="fas fa-sign-out-alt mr-2 text-sm" :class="[isActive ? 'opacity-75' : 'text-gray-400']"></i>
                            ออกจากระบบ
                        </a>
                    </router-link>
                </li>
